    ...
    for (let _childKey in _child) {
      ...
      */
      ...
      switch (childData.valType) {
        ...
        case "object":
          ...
          switch (parentData.valType) {
            case "string":
              ...
              console.log('build: ', _parent[childData.formattedKey]);

              deepSearch(_parent[childData.formattedKey], childData.val);
              break;

            case "object":
              deepSearch(parentData.val, childData.val);
              break;
        ...
        default: throwError({ message: "Child value must be object or string", got: childData.valType });
      }
